...
// ukoliko je kliknuto dugme za logout
...
// uzimamo korisnicki id na osnovu sesije (tj. ulogovanog korisnika)
$id = $_SESSION['user'];
$novac = 0;


// postavljamo cart sesiju ovde jer nam treba i na ovoj stranici
// tj da se azurira broj stavki pored "Korpa"
...
// pravimo asocijativni niz gde cemo skladistiti sve podatke o svim proizvodima koji su u bazi, tj. tabeli "artikli"
$productInfo = array(
	'id' => array(),
	'naziv' => array(),
	'cena' => array(),
...
// IZABERI SVE IZ artikli SORTIRAJ PO nazivu
$sql = "SELECT * FROM artikli ORDER BY naziv";
$res = $conn->query($sql);

// ubacujemo vrednosti u asocijativni niz $productInfo
while ($row = $res->fetch_assoc()) {
...
// ovde pravimo funkciju koja na osnovu kliknutog artikla salje isti u sesijski niz "cart"
// da bi se on upotrebio za racunanje i sl u cart.php
$requests = array();
		...
		<div class="container px-4 px-lg-5">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4 text-center">
					<li class="nav-item"><a class="nav-link active" aria-current="page" href="./index.php">Почетна</a></li>
