...
// uzimamo da je $id jednak id-u ulogovanog korisnika
$id = $_SESSION['user'];

// novac nam treba da bismo prikazali to na navbar-u
$novac = 0;
...
// asocijativni niz, ovo je isto kao i za index.php samo sto se ovde prikazuju pretrazeni artikli
$productInfo = array(
	'id' => array(),
	'naziv' => array(),
	'cena' => array(),
...
// ovo je jedino drugacije, trazimo pojam u bazi koji se podudara sa bilo koje strane, npr ako je pojam "keks"
// ovo ce da izbaci i "blabla keks" i "keks blabla"
if(isset($_GET['search'])) {
	$pojam = '%'.$_GET['searched_item'].'%';

	// IZABERI SVE IZ artikli GDE JE naziv SLICAN $pojam SORTIRAJ PO nazivu
	$sql = "SELECT * FROM artikli WHERE naziv LIKE '$pojam' ORDER BY naziv";

	// pravimo novi asocijativni niz, tj. praznimo prethodni i u njega ubacujemo nove vrednosti.
	$productInfo = array(
		'id' => array(),
		'naziv' => array(),
		'cena' => array(),
